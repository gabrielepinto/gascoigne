...
setup(
  ...
  version = 'v.1',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/gabrielepinto/gascoigne/archive/v.1.tar.gz',    # I explain this later on
